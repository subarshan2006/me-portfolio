      ...
      <div className="section-container">
        ...
        >
          ...
          <div className="contact-cards">
            <a href="mailto:hello@subarshan.dev" className="contact-card floating-card">
              ...
              <span className="contact-card-value">hello@subarshan.dev</span>
            </a>

            <a href="https://github.com/subarshan" target="_blank" rel="noopener noreferrer" className="contact-card floating-card">
              <div className="contact-card-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://linkedin.com/in/subarshan" target="_blank" rel="noopener noreferrer" className="contact-card floating-card">
              <div className="contact-card-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Big CTA */}
          <a href="mailto:hello@subarshan.dev" className="contact-cta">
            <span>Say Hello</span>
